...
""")
    ...
    def test_full_workflow_with_realistic_bundle(self, realistic_bundle):
        ...
        bundle = PlatingBundle(plating_dir=realistic_bundle, name="bucket", component_type="resource")
...
''')
    ...
    """
            ...
            with patch.object(adorner.component_finder, "find_source") as mock_find:
                ...
                # Dress the component
                success = await adorner._adorn_component("database", "resource", mock_component)
                assert success
                ...
                bundle = PlatingBundle(plating_dir=plating_dir, name="database", component_type="resource")
    ...
    def test_error_handling_with_invalid_bundle(self):
        ...
        with tempfile.TemporaryDirectory() as tmp_dir:
            ...
            bundle = PlatingBundle(plating_dir=bundle_dir, name="invalid", component_type="resource")
