...
**CRITICAL FIX** - Add to `/REDACTED_ABS_PATH` at line 216:
...
# Or install as tool
uv tool install --from /REDACTED_ABS_PATH tofusoup
```
...
1. `/REDACTED_ABS_PATH` - Main implementation
2. `/REDACTED_ABS_PATH` - TDD tests
3. `/REDACTED_ABS_PATH` - Plugin cache fix
