...
class ExampleCompiler:
    ...
    def compile_examples(
        ...
        for bundle in bundles:
            ...
            bundle_type = ComponentType(bundle.component_type) if isinstance(bundle.component_type, str) else bundle.component_type
...
"""
    ...
    def _generate_showcase_readme(self, bundles: list[PlatingBundle]) -> str:
        ...
        component_list = "\n".join(
            f"- {(ComponentType(bundle.component_type) if isinstance(bundle.component_type, str) else bundle.component_type).value.replace('_', ' ').title()}: `{bundle.name}`" for bundle in bundles
        )
